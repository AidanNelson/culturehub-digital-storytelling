!(function () {
  ...
  null == i &&
    ...
    i.register('j5U6Y', function (e, t) {
      ...
      (e.exports.formatArgs = function (t) {
        ...
        (e.exports.save = function (t) {
          try {
            t
              ? e.exports.storage.setItem('debug', t)
              : e.exports.storage.removeItem('debug');
          } catch (e) {}
        }),
    ...
    i.register('fW3Z9', function (e, t) {
      ...
      function u() {
        p &&
          c &&
          ((p = !1), c.length ? (d = c.concat(d)) : (l = -1), d.length && h());
      }
      function h() {
        if (!p) {
          var e = o(u);
      ...
      function P() {
        if ('object' == typeof navigator && 'ReactNative' === navigator.product)
          return 'undefined' == typeof RTCPeerConnection
            ...
            : (R.debug('this._detectDevice() | ReactNative handler chosen'),
              'ReactNative');
        if (
          ...
          const e = navigator.userAgent,
            ...
            r = t.getEngine();
          if (t.satisfies({ chrome: '>=74', chromium: '>=74' }))
            return 'Chrome74';
        ...
        switch (i) {
          case 'video/h264':
            ...
            if (r) {
              ...
              let r;
              try {
                r = n.generateProfileLevelIdForAnswer(
                  e.parameters,
                  t.parameters
                );
              } catch (e) {
        ...
        (e.exports.getExtendedRtpCapabilities = function (e, t) {
          ...
          for (const s of r.codecs) {
            const r = e.codecs.find(
                (e) => _(e) && e.parameters.apt === s.localPayloadType
              ),
              i = t.codecs.find(
                (e) => _(e) && e.parameters.apt === s.remotePayloadType
              );
            r &&
              i &&
    ...
    i.register('d0NZR', function (t, r) {
      ...
      (C = function (e) {
        ...
        switch (r) {
          ...
          default:
            return (
              E('parseProfileLevelId() | unrecognized level_idc:%s', r), null
            );
        }
        for (const e of B)
          if (i === e.profile_idc && e.profile_iop.isMatch(s))
            return new j(e.profile, a);
        return (
          E(
    ...
    i.register('cdWGp', function (e, t) {
      ...
      class _ extends c.EnhancedEventEmitter {
        ...
        async restartIce({ iceParameters: e }) {
          if ((g.debug('restartIce()'), this._closed))
        ...
        async produce({
          ...
          if ((g.debug('produce() [track:%o]', e), !e))
        ...
        async consumeData({
          ...
          if (
            (g.debug('consumeData()'), (r = p.clone(r, void 0)), this._closed)
          )
            throw new d.InvalidStateError('closed');
          if ('recv' !== this._direction)
            throw new d.UnsupportedError('not a receiving Transport');
          ...
          return (
            ...
            this._awaitQueue.push(async () => {
              const { dataChannel: n } = await this._handler.receiveDataChannel(
                  { sctpStreamParameters: r, label: s, protocol: i }
                ),
        ...
        constructor({
          ...
          super(),
            ...
            (this._awaitQueue = new n.AwaitQueue({
          ...
          return e.split(';').map(function (e) {
            return e.split(',').map(function (e) {
              ...
              return (
                '~' !== e[0]
                  ? (t = l(e))
                  : ((t = l(e.substring(1, e.length))), (r = !0)),
                { scid: t, paused: r }
              );
            });
          });
      ...
      Object.defineProperty(e.exports, '__esModule', { value: !0 }),
        ...
        (e.exports.getRtpEncodings = function ({ offerMediaObject: e }) {
          ...
          for (const s of e.ssrcGroups || []) {
            ...
            (e = Number(e)),
              (i = Number(i)),
              t.has(e) && (t.delete(e), t.delete(i), r.set(e, i));
          }
    ...
    i.register('bYqSi', function (e, t) {
      ...
      e.exports.RemoteSdp = class {
        ...
        planBStopReceiving({ mid: e, offerRtpParameters: t }) {
          ...
          s.planBStopReceiving({ offerRtpParameters: t }),
                  ...
                  switch (e.mimeType.toLowerCase()) {
                    case 'audio/opus':
                      void 0 !== t &&
                        ...
                        (r.stereo = t ? 1 : 0)),
                        void 0 !== s &&
                          ((h.parameters.useinbandfec = s ? 1 : 0),
                          (r.useinbandfec = s ? 1 : 0)),
                        void 0 !== i &&
                          ((h.parameters.usedtx = i ? 1 : 0),
                          (r.usedtx = i ? 1 : 0)),
    ...
    i.register('6vFw9', function (e, t) {
      ...
      Object.defineProperty(e.exports, '__esModule', { value: !0 }),
        (e.exports.addLegacySimulcast = e.exports.getRtpEncodings = void 0),
        (e.exports.getRtpEncodings = function ({
          offerMediaObject: e,
          track: t,
        }) {
          let r;
          ...
          for (const t of e.ssrcGroups || []) {
            ...
            (e = Number(e)),
              (r = Number(r)),
              s.has(e) && (s.delete(e), s.delete(r), i.set(e, r));
          }
    ...
    i.register('01sYR', function (e, t) {
      ...
      class _ extends h.HandlerInterface {
        ...
        async receive({ trackId: e, kind: t, rtpParameters: r }) {
          ...
          return (
            this._mapRecvLocalIdInfo.set(s, { mid: i, rtpParameters: r }),
            { localId: s, track: u }
          );
        }
        async stopReceiving(e) {
    ...
    i.register('8GXS8', function (e, t) {
      ...
      class h extends l.HandlerInterface {
        ...
        async send({ track: e, encodings: t, codecOptions: r, codec: s }) {
          ...
          for (const e of t)
            (e.ssrc = c.generateRandomNumber()),
              n && (e.rtx = { ssrc: c.generateRandomNumber() });
          (a.encodings = t),
        ...
        async receive({ trackId: e, kind: t, rtpParameters: r }) {
          ...
          u.debug('receive() | calling rtpReceiver.receive() [params:%o]', i),
            await s.receive(i);
          const a = e;
          return (
            this._rtpReceivers.set(a, s),
            { localId: a, track: s.track, rtpReceiver: s }
          );
        }
        async stopReceiving(e) {
    ...
    i.register('adPEn', function (e, t) {
      ...
      var r =
        ...
        s =
          ...
          function (e, t) {
            for (var s in e)
              'default' === s || t.hasOwnProperty(s) || r(t, e, s);
          };
      Object.defineProperty(e.exports, '__esModule', { value: !0 }),
        s(i('cUDrk'), e.exports),
        s(i('cdWGp'), e.exports),
  ...
  window.SimpleMediasoupPeer = class {
    on(e, t) {
      'track' == e &&
        (f(`setting callback for ${e} callback`), (this.onTrackCallback = t));
    }
    callOnTrackCallback({ track: e, peerId: t, label: r }) {
      this.onTrackCallback
        ? this.onTrackCallback(e, t, r)
        : f('no onTrack Callback Set');
    }
    async disconnect() {
    ...
    async handleSocketMessage(e) {
      switch (e.type) {
        ...
        case 'createConsumer':
          ...
          break;
        case 'consumerClosed': {
          f('Server-side consumerClosed, closing client side consumer.'),
            f(e.data);
    ...
    async createSendTransport() {
      ...
      (this.sendTransport = this.device.createSendTransport({
        ...
        this.sendTransport.on(
          ...
          async ({ kind: e, rtpParameters: t, appData: r }, s, i) => {
            try {
              ...
              const { id: i } = await this.socket.request(
                'mediasoupSignaling',
                {
                  type: 'produce',
                  data: {
        ...
        this.sendTransport.on(
          'producedata',
          async (
            { sctpStreamParameters: e, label: t, protocol: r, appData: s },
            i,
            a
          ) => {
            try {
              const { id: a } = await this.socket.request(
                'mediasoupSignaling',
                {
                  type: 'produceData',
                  data: {
